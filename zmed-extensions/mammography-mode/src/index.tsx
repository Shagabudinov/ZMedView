...
const zmedAIInnopolis = {
  panel: 'zmed-common.panelModule.panelZMedAIInnopolist',
};
        ...
        layoutTemplate: () => {
          return {
            ...
            props: {
              ...
              rightPanels: [dicomSeg.panel, tracked.measurements, zmedAIInnopolis.panel],
